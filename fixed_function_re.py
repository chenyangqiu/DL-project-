...
from dataset import generate_dataset, generate_function
...
fixed_function = generate_function(num_of_nodes, num_of_edges, dim)
train_set = generate_dataset(size=num_of_train, num_of_nodes=num_of_nodes,
                             num_of_edges=num_of_edges, fix_func=fixed_function)
